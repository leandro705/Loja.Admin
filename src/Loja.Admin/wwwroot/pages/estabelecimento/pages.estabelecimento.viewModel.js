...
pages.estabelecimento.viewModel = function () {   
    ...
    var viewModelEstabelecimento = new function () {
        ...
        self.contato = function (estabelecimentoId) {
            pages.dataServices.bloquearTela();
            window.location.href = "/Estabelecimento/Contato/" + estabelecimentoId;
        };
    ...
    $('#datatable-estabelecimento tbody').on('click', '#btnDetalhes', function (event) {
        var estabelecimentoId = event.currentTarget.value;
        viewModelEstabelecimento.contato(estabelecimentoId);
    });
